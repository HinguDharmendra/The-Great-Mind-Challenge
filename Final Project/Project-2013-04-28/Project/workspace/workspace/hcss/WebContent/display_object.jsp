...
<%
String src1 = request.getParameter("pname");
String src = src1.substring(0, src1.length()-2);
//out.println(src.charAt(53));
%>
                    ...
                    <div class="slider-wrap">
                            <div id="slider1" class="csw">
                                    <div class="panelContainer">
                                            <div class="panel" title="Registration Successful">
                                                <div class="wrapper">
                                                    <video width="320" height="240" controls>
                                                        <source src="<%out.println(src);%>" type="video/mp4" autoplay="autoplay">
                                                    </video>
                                                </div>
