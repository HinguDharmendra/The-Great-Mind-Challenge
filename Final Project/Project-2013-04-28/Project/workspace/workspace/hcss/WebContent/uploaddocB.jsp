...
File fd = new File("C:/Data/"+session.getAttribute("Username")+"/documents");
if(!fd.exists())
    fd.mkdir();

File ffd = new File("C:/Data/"+session.getAttribute("Username")+"/documents/"+saveFile);
FileOutputStream fileOut = new FileOutputStream(ffd);

fileOut.write(dataBytes, startPos, (endPos - startPos));
fileOut.flush();
fileOut.close();
String path = ffd.getPath();
//  out.println(path);
