...
while(rs4.next())
{
    for(int i=1;i<=numberOfColumns4;i+=2)
    {
        ...
        <ul type="none">
            <li>
                <input class="rdSelect" id="pname" type="radio" name="pname" value="<%out.println(rs4.getString(i+1));%>" required="required"/><%out.println(rs4.getString(i));%>
            </li>
...
%>
    ...
    <tr>
        ...
        <td><INPUT NAME="file" TYPE="file" accept="audio/*" required="required"></td>
    </tr>
